...
- **Spelling is forgiving.** "6av", "6 ave", "6th Avenue", and "Sixth Ave" all land on the same station: glued words split apart, number words are read, and ordinals were already handled.
