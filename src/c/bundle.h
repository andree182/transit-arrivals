...
typedef struct { char dest[21]; uint8_t dir; uint8_t n; uint16_t delta[MAX_ARR]; uint8_t expMask; } DirView;  // dir: 0=uptown(N), 1=downtown(S); expMask bit a => arrival a is express (v5+)
